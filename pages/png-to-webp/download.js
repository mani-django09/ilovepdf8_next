...
export default function PngToWebpDownload() {
      ...
      <Layout>
        <div className="fixed inset-0 bg-white z-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">Preparing your WebP download...</p>
  ...
  return (
    <>
      <Head>
        <title>Download WebP Images - PNG to WebP Conversion Complete</title>
        <meta name="description" content="Your PNG images have been successfully converted to WebP format. Download your optimized files now." />
      </Head>
          ...
          <div className="max-w-lg w-full">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Your PNG images have been optimized and converted to WebP format for better web performance.
              </p>
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-8">
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-500">{fileSize} MB • WebP Format</p>
                  </div>
                </div>
              </div>
              ...
              {!downloaded ? (
                ...
                >
                  ...
                  <span>Download WebP Images</span>
                </button>
              ) : (
