...
export default function JpgToPngDownload() {
      ...
      <Layout>
        <div className="fixed inset-0 bg-white z-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">Preparing your PNG download...</p>
  ...
  return (
    <>
      <Head>
        <title>Download PNG Images - JPG to PNG Conversion Complete</title>
        <meta name="description" content="Your JPG images have been successfully converted to PNG format. Download your files now." />
      </Head>
          ...
          <div className="max-w-lg w-full">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Your JPG images have been converted to PNG format with lossless quality.
              </p>
