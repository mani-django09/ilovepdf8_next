...
export default function PngToJpgDownload() {
      ...
      <Layout>
        <div className="fixed inset-0 bg-white z-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">Preparing your JPG download...</p>
  ...
  return (
    <>
      <Head>
        <title>Download JPG Images - PNG to JPG Conversion Complete</title>
        <meta name="description" content="Your PNG images have been successfully converted to JPG format. Download your files now." />
      </Head>
          ...
          <div className="max-w-lg w-full">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Your PNG images have been converted to JPG format with optimized file sizes.
              </p>
                ...
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-500">
                      {fileSize} MB • {isZipFile ? 'ZIP Archive with JPG Images' : 'JPG Image'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {!downloaded ? (
                ...
                >
                  ...
                  <span>Download {isZipFile ? 'Images ZIP' : 'JPG Image'}</span>
                </button>
              ) : (
