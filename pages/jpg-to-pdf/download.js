...
export default function JpgToPdfDownload() {
      ...
      <Layout>
        <div className="fixed inset-0 bg-white z-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">Preparing your PDF download...</p>
  ...
  return (
    <>
      <Head>
        <title>Download PDF - Images Successfully Converted</title>
        <meta name="description" content="Your images have been successfully converted to PDF. Download your document now." />
      </Head>
          ...
          <div className="max-w-lg w-full">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Your images have been converted to a professional PDF document.
              </p>
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-8">
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-500">{fileSize} MB • Ready for download</p>
                  </div>
                </div>
              </div>
