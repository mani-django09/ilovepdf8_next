...
export default function MergePdfDownload() {
      ...
      <Layout>
        <div className="fixed inset-0 bg-white z-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">Preparing your download...</p>
  ...
  return (
    <>
      <Head>
        <title>Download Merged PDF - PDF Files Successfully Combined</title>
          ...
          <div className="max-w-lg w-full">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              ...
              <div className="flex items-center justify-center space-x-3 mb-8 text-sm">
                ...
                <div className="flex items-center space-x-1">
                  <div className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center text-xs font-bold">✓</div>
                  <span className="text-green-600 font-medium">Merge</span>
                </div>
                <ArrowRight className="w-3 h-3 text-gray-400" />
                <div className="flex items-center space-x-1">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Your files have been successfully combined into a single document.
              </p>
